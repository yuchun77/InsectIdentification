...
if __name__ == '__main__':
    ...
    # button_for_seperate.place(anchor=tk.NW, height=100, width=350, x=120, y=250)
    #直接辨識
    button_for_direct = ttk.Button(root, text="Start", command=lambda:show("direct"), style='start.TButton', takefocus=0)
    # button_for_direct.place(anchor=tk.NW, height=100, width=350, x=600, y=250)
    button_for_direct.place(anchor=tk.NW, height=100, width=350, x=360, y=250)
